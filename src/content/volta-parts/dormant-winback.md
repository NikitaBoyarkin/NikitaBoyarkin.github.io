...
От меня требовалось проверить, возвращает ли ассистированная реактивация дормантов старшего возраста и окупается ли она. Это был последний проект слоя валидации, и я отвечал за проверку утверждения о UX-барьере.
