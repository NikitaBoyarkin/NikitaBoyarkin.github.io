...
От меня требовалось проверить деньгами рекомендацию предыдущего этапа — отдельный trust-трек для сегмента старшего возраста. Как первый проект слоя валидации, я отвечал за её экономическую оценку.
