...
Мне нужно было найти, на каком шаге онбординга необанк «Volta» теряет пользователей. Как первый проект петли discover, я отвечал за то, чтобы данные были воспроизводимы через seeded-генератор.
