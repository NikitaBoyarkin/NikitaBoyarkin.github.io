...
От меня требовалось проверить эффект KYC-фикса на удержании, а не ограничиться результатом после запуска. Нужно было построить когортные треугольники вместо усреднения по всей базе.
