...
От меня требовалось разобраться, кто именно эти пользователи и как их монетизировать. Эффект удержания был подтверждён, и следующим шагом стала сегментация базы.
