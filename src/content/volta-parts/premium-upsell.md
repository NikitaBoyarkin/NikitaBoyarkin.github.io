...
Мне нужно было проверить, переносится ли апселл, найденный в якорном сегменте, на другие сегменты. От меня требовалось оценить границы применимости найденного решения.
