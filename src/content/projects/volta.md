...
- **M3 retention +9.2pp** → **+€227K/yr** incremental LTV от KYC-фикса; DiD подтверждает причинность (ATT +9,09 п.п.).
- **4 сегмента** с per-segment стратегией и монетизацией до **+€310K/yr** через миграцию.
- **Воспроизводимая методология** — CUPED, AA-test, Bonferroni, DiD, sensitivity at MDE; 4 рекомендованных A/B для валидации стратегии.
- **23 проекта** — 12 аналитических доменов + Market & Jobs (JTBD) + слой валидации RAT v2 + causal: от funnel до win-back дормантов.
